<%-- 
    Document   : Home
    Created on : Feb 12, 2021, 7:08:45 PM
        ...
        <main>
            ...
            <div class="slider-area ">
                ...
                <div class="slider-active">
                    <div class="single-slider slider-height" data-background="https://saigontile.com/wp-content/uploads/2020/04/gach-lat-nen-800x800-trung-quoc-van-khoi-mau-xam-dty8882.jpg">
                        <div class="container">
                            <div class="row d-flex align-items-center justify-content-between">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-none d-md-block">
                                    <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                        <img src="https://chiemtaimobile.vn/images/thumbnails/500/500/detailed/16/actc-3fj6dqhvmeosakjps4vbgqov0qywyhd97fw_vx6y9uzx6nkiykvvk7oqjw_m5zerrolh14gb-jdrnvmiihmk4er1pdthwjscbpef9oqkhcm8quhol9gagxwb6zskjcpb1mloqgkuk5crrpoavfdbwe_1g=s661-no.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-8" style="margin-top: 62px;">
                                    <div class="hero__caption">
                                        ...
                                        <h1 data-animation="fadeInRight" data-delay=".6s">Essential oil steam generator</h1>
                                        <p data-animation="fadeInRight" data-delay=".8s">Best Choice Of 2020!</p>
                                        <!-- Hero-btn -->
                            ...
                            <div class="single-category mb-30">
                                <div class="category-img">
                                    <a href="category?catID=1">
                                        <img src="assets/img/categories/tinhdau.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="single-category mb-30">
                                <div class="category-img text-center">
                                    <a href="category?catID=2">
                                        <img src="assets/img/categories/may5.jpg" alt="">      
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="single-category mb-30">
                                <div class="category-img">
                                    <a href="category?catID=3">
                                        <img src="assets/img/categories/den1.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Shop Method End-->
            <!-- Best Product Start -->
            <div class="best-product-area lf-padding" style="background: rgb(250 27 4 / 9%);">
                <div class="product-wrapper bg-height" >
                    <div class="container position-relative">
                        <div class="row justify-content-between align-items-end">
                            <div class="product-man position-absolute  d-none d-lg-block" style="left: -20%; top: 25%;">
                                <img src="assets/img/hero/anh2.jpg" alt="">
                            </div>
